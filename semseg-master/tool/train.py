...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/ade20k/ade20k_EDPNet.yaml', help='config file')
    parser.add_argument('opts', help='see config/ade20k/ade20k_EDPNet.yaml for all options', default=None, nargs=argparse.REMAINDER)
...
def check(args):
    ...
    assert args.zoom_factor in [1, 2, 4, 8,16]
    if args.arch == 'edp':
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.arch == 'edp':
        ...
        model = EDPNet(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, criterion=criterion)
        # modules_ori = [model.layer0, model.layer1, model.layer2, model.layer3, model.layer4]
        modules_ori = [model.layer0, model.layer1, model.layer2, model.layer3, model.layer4,model.layer5, model.layer6, model.layer7, model.layer8, model.layer9
                       ,model.layer10, model.layer11, model.layer12, model.layer13, model.layer14,model.layer15, model.layer16, model.layer17, model.layer18, model.layer19
                       ,model.layer20, model.layer21]
