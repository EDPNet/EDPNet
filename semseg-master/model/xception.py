...
class Xception(nn.Module):
    ...
    def __init__(self, zoom_factor):
        ...
        self.block3 = Block(256, 728, stride_list[2])
...
# def xception(pretrained=True, downsample_factor=16): #___
def xception(pretrained=False, zoom_factor=8):
    model = Xception(zoom_factor=zoom_factor)
    if pretrained:
        model_path = './initmodel/xception_pytorch_imagenet.pth'
        # model_path = './initmodel/train_epoch_15000.pth'
